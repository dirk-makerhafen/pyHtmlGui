    ...
    def _worker_thread(self):
        while True:
            ...
            for item in self.items:
                item.update()
            self.notify_observers() # in this example, this is useless for show only, its only to show that we can ignore this later in the view via self._on_observedObject_updated = None
